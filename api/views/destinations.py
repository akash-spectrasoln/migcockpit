    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            try:
                ...
                name_column = 'destination_name'
                if 'name' in existing_columns:
                    name_column = 'name'
                elif 'dest_name' in existing_columns:
                    name_column = 'dest_name'
                ...
                config_column = 'destination_config'
                if 'config_data' in existing_columns:
                    config_column = 'config_data'
                elif 'dst_config' in existing_columns:
                    config_column = 'dst_config'
                elif 'dest_config' in existing_columns:
                    config_column = 'dest_config'
                ...
                name_col_q = f'"{name_column}"'
                config_col_q = f'"{config_column}"'
                order_col = 'id' if 'id' in existing_columns else 'created_on'
                cursor.execute(
                    f'''
...
class DestinationEditView(APIView):
    ...
    def get(self, request, destination_id):
        ...
        try:
            ...
            name_q, config_q = f'"{name_col}"', f'"{config_col}"'
