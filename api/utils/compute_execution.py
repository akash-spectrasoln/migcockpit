...
class ComputeNodeCompileView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.info(f"[Compile] Code validation successful")
            return Response(
                {
                    "success": True,
