...
class ReadOnlyDataFrame:
    ...
    def __init__(self, df: pd.DataFrame, name: str = "input_df"):
        ...
        Args:
            ...
            name: Name for error messages (default: "input_df")
        """
...
class ComputeNodeContract:
    ...
    def validate_output(self, output_df: Any) -> pd.DataFrame:
        ...
        if output_df is None:
            raise ValueError(
                f"Compute node must assign a DataFrame to 'output_df'. "
...
@contextmanager
def readonly_dataframe_context(df: pd.DataFrame, name: str = "input_df"):
    """
