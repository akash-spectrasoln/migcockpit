...
import { EnhancedDataFlowCanvas } from '../components/Canvas/DataFlowCanvasChakra'
...
export const CanvasPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (canvasIdFromUrl) {
      ...
      const targetCanvas = canvasesData?.data?.find((c: any) => c.id === canvasIdFromUrl)
      ...
      if (targetCanvas) {
        ...
        // Schema drift detection runs inside EnhancedDataFlowCanvas once nodes are in the store
      }
    } else {
