...
import { DestinationSelectorModal } from '../components/Canvas/DestinationSelectorModal'
...
export const DashboardPage: React.FC = () => {
  ...
  const { data: sourcesData, isLoading: isSourcesLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Axios wraps it in { data: { customer_id, customer_name, sources: [...] } }
  ...
  const { data: destinationsData, isLoading: isDestinationsLoading } = useQuery({
    ...
    queryFn: () => connectionApi.getDestinations(),
  })

  const { data: canvasesData, isLoading: isCanvasesLoading } = useCanvases()
                      ...
                      >
                        ...
                        <HStack spacing={2}>
                          ...
                          <Button
                            ...
                            colorScheme="red"
                            variant="ghost"
                            isLoading={deleteCanvasMutation.isLoading}
                            onClick={(e) => {
                              e.stopPropagation()
