...
const LoginPage = lazy(() => import('../pages/LoginPageChakra').then(m => ({ default: m.LoginPage })))
const DashboardPage = lazy(() => import('../pages/DashboardPageChakra').then(m => ({ default: m.DashboardPage })))
