...
class HanaConnection:
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "message": f"HANA connection test failed: {str(e)}"}
    ...
    def get_mapping_data(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise Exception(f"Failed to get mapping data from HANA: {str(e)}")
    ...
    def get_staging_tables_for_project(self, sys_id: str, mt_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise Exception(f"Failed to get staging tables for project {sys_id}_{mt_id}: {str(e)}")
    ...
    def get_project_data(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise Exception(f"Failed to get project data from HANA: {str(e)}")
...
class HanaService:
    ...
    def test_project_query(self, hana_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "message": f"Project data query test failed: {str(e)}"}
    ...
    def complete_import_process(self, hana_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Complete import process failed: {str(e)}")
...
def create_hana_connection(config: Dict[str, Any] = None) -> HanaConnection:
