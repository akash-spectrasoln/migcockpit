...
def test_complex_pipeline():
    ...
    print(f"   Pre-destination staging: staging_jobs.job_<job_id>_node_<node_id> ✓")
    print(f"   Post-JOIN chain: Compiled as nested SQL into staging table ✓")
    print(f"   Final INSERT: FROM staging table (allows verification) ✓")
    print(f"   Memory usage: ~50 MB (constant, regardless of data size)")
    print(f"   All transformations executed in PostgreSQL ✓")
